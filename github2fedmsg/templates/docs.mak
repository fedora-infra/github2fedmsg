...
<div class="content">
  <div class="row">
    <span class="span6 offset3">
      <h1>"Docs"</h1>
      <p>
      <a href="http://pep8.me">github2fedmsg</a> works by installing
      webhooks in your github repositories.  Whenever someone pushes commits
      and issues a pull request on one of yours, <a
      href="http://pep8.me">github2fedmsg</a> will be notified of the
      ...
      <code>setup.cfg</code> and <a href="http://pep8.me">github2fedmsg</a> will
      obey those exceptions.  </p>
      <p>For instance, if you setup your <code>setup.cfg</code> to look like
      this, <a href="http://pep8.me">github2fedmsg</a> will ignore error number
      126</p>
    <pre>
    [pep8]
    ignore=E126
